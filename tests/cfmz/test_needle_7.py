"""
No Vlasov force, high collision frequency ν=100
------------------------------------------------
Uniform initial angle distribution, no mean-field torque.  Tests the
solver at a high collision regime (collision ratio ν·dt = 1).
"""
import sys
import petsc4py
