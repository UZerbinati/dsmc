"""
Hard-needle cross-section — Kuramoto meanfield Vlasov force, alternative seed
------------------------------------------------------------------------------
Same as test_6 (Kuramoto mean-field torque F(θ) = −sin(θ − θ_av), seed=49)
...
Compare with test_6 (same parameters, Maxwell kernel) to check reproducibility
of the hard-needle NTC results across different random seeds.
"""
import sys
import petsc4py
...
Opt = PETSc.Options()
Print("Running homogeneous CFMZ needle DSMC — hard-needle cross-section (NTC), Kuramoto Vlasov, seed=49:")
