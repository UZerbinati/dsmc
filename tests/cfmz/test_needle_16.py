"""
Hard-needle cross-section — quadratic Vlasov force, α=4
--------------------------------------------------------
Same as test_3 (quadratic mean-field torque F(θ) = −4(θ − θ_av), α=4) but
...
Compare with test_3 (same parameters, Maxwell kernel) to observe the effect of
the anisotropic cross-section with stronger quadratic confinement (α=4).
"""
import sys
import petsc4py
...
Opt = PETSc.Options()
Print("Running homogeneous CFMZ needle DSMC — hard-needle cross-section (NTC), quadratic Vlasov α=4:")
