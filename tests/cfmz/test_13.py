...
def vlasov_force(theta):
    ...
    if comm.Get_rank() == 0:
        ...
        fig.savefig(f"output/test_13_output_cfmz_{collision_type}/vlasov_energy.pdf", bbox_inches="tight")
        fig.savefig(f"output/test_13_output_cfmz_{collision_type}/vlasov_energy.png", dpi=400, bbox_inches="tight")
        plt.close(fig)
