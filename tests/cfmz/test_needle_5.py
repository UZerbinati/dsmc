"""
Kuramoto meanfield Vlasov force, perturbed IC
----------------------------------------------
Mean-field torque: F(θ) = −sin(θ − θ_av).  Initial angle distribution
is a small perturbation of the uniform (amplitude=0.1, wavelength=1).
"""
import sys
import petsc4py
